...
public class SongForgeUpgradeSlot extends AutomatableSlot {

    private SongForgeBlockEntity be;

    public SongForgeUpgradeSlot(SongForgeBlockEntity be, AutomatableItemStackHandler inventory, int index, int x, int y) {
