...
public class ItemInit
{
    ...
    public static final RegistryObject<BlockItem> CHASM_SIGN = ITEMS.register("chasm_sign", () -> new SignItem((new Item.Properties()).stacksTo(16).tab(Geomancy.gemsmodblocktab), BlockInit.CHASM_SIGN.get(), BlockInit.CHASM_SIGN_WALL.get()));
    public static final RegistryObject<BlockItem> END_LANTERN = ITEMS.register("end_lantern", () -> new BlockItem(BlockInit.END_LANTERN.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> END_LANTERN_BLOCK = ITEMS.register("end_lantern_block", () -> new BlockItem(BlockInit.END_LANTERN_BLOCK.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_BUTTON = ITEMS.register("chasm_button", () -> new BlockItem(BlockInit.CHASM_BUTTON.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_DOOR = ITEMS.register("chasm_door", () -> new BlockItem(BlockInit.CHASM_DOOR.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_FENCE = ITEMS.register("chasm_fence", () -> new BlockItem(BlockInit.CHASM_FENCE.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_FENCE_GATE = ITEMS.register("chasm_fence_gate", () -> new BlockItem(BlockInit.CHASM_FENCE_GATE.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_LOG = ITEMS.register("chasm_log", () -> new BlockItem(BlockInit.CHASM_LOG.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_LOG_BARK = ITEMS.register("chasm_log_bark", () -> new BlockItem(BlockInit.CHASM_LOG_BARK.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_LOG_STRIPPED = ITEMS.register("chasm_log_stripped", () -> new BlockItem(BlockInit.CHASM_LOG_STRIPPED.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_LOG_STRIPPED_BARK = ITEMS.register("chasm_log_stripped_bark", () -> new BlockItem(BlockInit.CHASM_LOG_STRIPPED_BARK.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_PLANKS = ITEMS.register("chasm_planks", () -> new BlockItem(BlockInit.CHASM_PLANKS.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_PLATE = ITEMS.register("chasm_plate", () -> new BlockItem(BlockInit.CHASM_PLATE.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_SLAB = ITEMS.register("chasm_slab", () -> new BlockItem(BlockInit.CHASM_SLAB.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_STAIRS = ITEMS.register("chasm_stairs", () -> new BlockItem(BlockInit.CHASM_STAIRS.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_TRAPDOOR = ITEMS.register("chasm_trapdoor", () -> new BlockItem(BlockInit.CHASM_TRAPDOOR.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> CHASM_LEAVES = ITEMS.register("chasm_leaves", () -> new BlockItem(BlockInit.CHASM_LEAVES.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> MULMUS_LANTERN = ITEMS.register("mulmus_lantern", () -> new BlockItem(BlockInit.MULMUS_LANTERN.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> MULMUS_LANTERN_POLISHED = ITEMS.register("mulmus_lantern_polished", () -> new BlockItem(BlockInit.MULMUS_LANTERN_POLISHED.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> INFUSION_TABLE = ITEMS.register("infusion_table", () -> new BlockItem(BlockInit.INFUSION_TABLE.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> DIPPER = ITEMS.register("dipper", () -> new BlockItem(BlockInit.DIPPER.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> DREAM_CATCHER = ITEMS.register("dream_catcher", () -> new BlockItem(BlockInit.DREAM_CATCHER.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> GEODE_ORE = ITEMS.register("geode_ore", () -> new BlockItem(BlockInit.GEODE_ORE.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TELEPAD = ITEMS.register("telepad", () -> new BlockItem(BlockInit.TELEPAD.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TELEPAD_SLAB = ITEMS.register("telepad_slab", () -> new BlockItem(BlockInit.TELEPAD_SLAB.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    ...
    public static final RegistryObject<BlockItem> TREADSTONE_1 = ITEMS.register("treadstone_1", () -> new BlockItem(BlockInit.TREADSTONE_1.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_2 = ITEMS.register("treadstone_2", () -> new BlockItem(BlockInit.TREADSTONE_2.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_3 =  ITEMS.register("treadstone_3", () -> new BlockItem(BlockInit.TREADSTONE_3.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_4 = ITEMS.register("treadstone_4", () -> new BlockItem(BlockInit.TREADSTONE_4.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_5 = ITEMS.register("treadstone_5", () -> new BlockItem(BlockInit.TREADSTONE_5.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_6 = ITEMS.register("treadstone_6", () -> new BlockItem(BlockInit.TREADSTONE_6.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_7 = ITEMS.register("treadstone_7", () -> new BlockItem(BlockInit.TREADSTONE_7.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_SLAB_1 = ITEMS.register("treadstone_slab_1", () -> new BlockItem(BlockInit.TREADSTONE_SLAB_1.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_SLAB_2 = ITEMS.register("treadstone_slab_2", () -> new BlockItem(BlockInit.TREADSTONE_SLAB_2.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_SLAB_3 =  ITEMS.register("treadstone_slab_3", () -> new BlockItem(BlockInit.TREADSTONE_SLAB_3.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_SLAB_4 = ITEMS.register("treadstone_slab_4", () -> new BlockItem(BlockInit.TREADSTONE_SLAB_4.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_SLAB_5 = ITEMS.register("treadstone_slab_5", () -> new BlockItem(BlockInit.TREADSTONE_SLAB_5.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_SLAB_6 = ITEMS.register("treadstone_slab_6", () -> new BlockItem(BlockInit.TREADSTONE_SLAB_6.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_SLAB_7 = ITEMS.register("treadstone_slab_7", () -> new BlockItem(BlockInit.TREADSTONE_SLAB_7.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_STAIR_1 = ITEMS.register("treadstone_stair_1", () -> new BlockItem(BlockInit.TREADSTONE_STAIR_1.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_STAIR_2 = ITEMS.register("treadstone_stair_2", () -> new BlockItem(BlockInit.TREADSTONE_STAIR_2.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_STAIR_3 =  ITEMS.register("treadstone_stair_3", () -> new BlockItem(BlockInit.TREADSTONE_STAIR_3.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_STAIR_4 = ITEMS.register("treadstone_stair_4", () -> new BlockItem(BlockInit.TREADSTONE_STAIR_4.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_STAIR_5 = ITEMS.register("treadstone_stair_5", () -> new BlockItem(BlockInit.TREADSTONE_STAIR_5.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_STAIR_6 = ITEMS.register("treadstone_stair_6", () -> new BlockItem(BlockInit.TREADSTONE_STAIR_6.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_STAIR_7 = ITEMS.register("treadstone_stair_7", () -> new BlockItem(BlockInit.TREADSTONE_STAIR_7.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_CARPET_1 = ITEMS.register("treadstone_carpet_1", () -> new BlockItem(BlockInit.TREADSTONE_CARPET_1.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_CARPET_2 = ITEMS.register("treadstone_carpet_2", () -> new BlockItem(BlockInit.TREADSTONE_CARPET_2.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_CARPET_3 =  ITEMS.register("treadstone_carpet_3", () -> new BlockItem(BlockInit.TREADSTONE_CARPET_3.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_CARPET_4 = ITEMS.register("treadstone_carpet_4", () -> new BlockItem(BlockInit.TREADSTONE_CARPET_4.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_CARPET_5 = ITEMS.register("treadstone_carpet_5", () -> new BlockItem(BlockInit.TREADSTONE_CARPET_5.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_CARPET_6 = ITEMS.register("treadstone_carpet_6", () -> new BlockItem(BlockInit.TREADSTONE_CARPET_6.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
    public static final RegistryObject<BlockItem> TREADSTONE_CARPET_7 = ITEMS.register("treadstone_carpet_7", () -> new BlockItem(BlockInit.TREADSTONE_CARPET_7.get(), new Item.Properties().tab(Geomancy.gemsmodblocktab)));
