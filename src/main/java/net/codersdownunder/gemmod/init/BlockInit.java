...
public class BlockInit
{
   ...
   public static final RegistryObject<Block> TREADSTONE_1 = BLOCKS.register("treadstone_1", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_2 = BLOCKS.register("treadstone_2", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_3 = BLOCKS.register("treadstone_3", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_4 = BLOCKS.register("treadstone_4", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_5 = BLOCKS.register("treadstone_5", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_6 = BLOCKS.register("treadstone_6", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_7 = BLOCKS.register("treadstone_7", () -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   
   public static final RegistryObject<Block> TREADSTONE_SLAB_1 = BLOCKS.register("treadstone_slab_1", () -> new SlabBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_SLAB_2 = BLOCKS.register("treadstone_slab_2", () -> new SlabBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_SLAB_3 = BLOCKS.register("treadstone_slab_3", () -> new SlabBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_SLAB_4 = BLOCKS.register("treadstone_slab_4", () -> new SlabBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_SLAB_5 = BLOCKS.register("treadstone_slab_5", () -> new SlabBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_SLAB_6 = BLOCKS.register("treadstone_slab_6", () -> new SlabBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_SLAB_7 = BLOCKS.register("treadstone_slab_7", () -> new SlabBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   
   public static final RegistryObject<Block> TREADSTONE_STAIR_1 = BLOCKS.register("treadstone_stair_1", () -> new StairBlock(() -> TREADSTONE_1.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_STAIR_2 = BLOCKS.register("treadstone_stair_2", () -> new StairBlock(() -> TREADSTONE_2.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_STAIR_3 = BLOCKS.register("treadstone_stair_3", () -> new StairBlock(() -> TREADSTONE_3.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_STAIR_4 = BLOCKS.register("treadstone_stair_4", () -> new StairBlock(() -> TREADSTONE_4.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_STAIR_5 = BLOCKS.register("treadstone_stair_5", () -> new StairBlock(() -> TREADSTONE_5.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_STAIR_6 = BLOCKS.register("treadstone_stair_6", () -> new StairBlock(() -> TREADSTONE_6.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_STAIR_7 = BLOCKS.register("treadstone_stair_7", () -> new StairBlock(() -> TREADSTONE_7.get().defaultBlockState(), BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   
   public static final RegistryObject<Block> TREADSTONE_CARPET_1 = BLOCKS.register("treadstone_carpet_1", () -> new CarpetBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_CARPET_2 = BLOCKS.register("treadstone_carpet_2", () -> new CarpetBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_CARPET_3 = BLOCKS.register("treadstone_carpet_3", () -> new CarpetBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_CARPET_4 = BLOCKS.register("treadstone_carpet_4", () -> new CarpetBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_CARPET_5 = BLOCKS.register("treadstone_carpet_5", () -> new CarpetBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_CARPET_6 = BLOCKS.register("treadstone_carpet_6", () -> new CarpetBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
   public static final RegistryObject<Block> TREADSTONE_CARPET_7 = BLOCKS.register("treadstone_carpet_7", () -> new CarpetBlock(BlockBehaviour.Properties.of(Material.STONE).strength(2.0F, 3.0F).requiresCorrectToolForDrops().sound(SoundType.STONE).speedFactor(2F)));
