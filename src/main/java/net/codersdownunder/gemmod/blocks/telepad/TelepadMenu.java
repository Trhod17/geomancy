...
public class TelepadMenu extends AbstractContainerMenu {
    ...
    public TelepadMenu() {
        super(MenuInit.TELEPAD_MENU.get(), id);
    }
    
    public TelepadMenu(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player)  {
        super(MenuInit.TELEPAD_MENU.get(), windowId);
        TelepadMenu.id = windowId;
        ...
        if (tileEntity != null) {
            tileEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(h -> {
            	...
            	addSlot(new GenericSlot(h, 0, 67, 45));
            });
        }
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(tileEntity.getLevel(), tileEntity.getBlockPos()), playerEntity, BlockInit.TELEPAD.get()) || stillValid(ContainerLevelAccess.create(tileEntity.getLevel(), tileEntity.getBlockPos()), playerEntity, BlockInit.TELEPAD_SLAB.get());
    }
