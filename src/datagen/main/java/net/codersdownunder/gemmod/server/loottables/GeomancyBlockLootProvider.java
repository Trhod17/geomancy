...
public class GeomancyBlockLootProvider extends BlockLootSubProvider implements LootTableSubProvider {
    public GeomancyBlockLootProvider() {
...
//                    ItemInit.SPARSE_GEODE.get(), 1f, 2f));
    ...
    protected LootTable.Builder createGeodeOreTable(Block block, Item lootItem, float min, float max,
        ...
        LootPool.Builder builder = LootPool.lootPool()
                .name(DataUtils.getBlockRegistryName(block))
                .setRolls(ConstantValue.exactly(1))
    ...
    protected LootTable.Builder createSlabItemTable(Block slab) {
        return LootTable.lootTable().withPool(LootPool.lootPool()
                .name(DataUtils.getBlockRegistryName(slab))
                .setRolls(ConstantValue.exactly(1))
